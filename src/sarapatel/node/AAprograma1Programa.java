...
public final class AAprograma1Programa extends PPrograma
{
    ...
    public Object clone()
    {
        return new AAprograma1Programa(
    ...
    {
        ((Analysis) sw).caseAAprograma1Programa(this);
    }
