...
public final class AIdAtribuicaoComandoAux extends PComandoAux
{
    private PIdAtribuicao _idAtribuicao_;

    public AIdAtribuicaoComandoAux()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdAtribuicaoComandoAux(
    ...
    {
        ((Analysis) sw).caseAIdAtribuicaoComandoAux(this);
    }
