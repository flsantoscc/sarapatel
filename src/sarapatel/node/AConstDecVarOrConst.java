...
public final class AConstDecVarOrConst extends PDecVarOrConst
{
    private PDecConst _decConst_;

    public AConstDecVarOrConst()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConstDecVarOrConst(
    ...
    {
        ((Analysis) sw).caseAConstDecVarOrConst(this);
    }
