...
public final class AAchamadaprocedimento2ChamadaProcedimento extends PChamadaProcedimento
{
    private TId _id_;
    private final LinkedList<PExp> _exp_ = new LinkedList<PExp>();

    public AAchamadaprocedimento2ChamadaProcedimento()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAchamadaprocedimento2ChamadaProcedimento(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAchamadaprocedimento2ChamadaProcedimento(this);
    }
