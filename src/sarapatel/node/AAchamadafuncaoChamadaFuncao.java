...
public final class AAchamadafuncaoChamadaFuncao extends PChamadaFuncao
{
    private TId _id_;
    private final LinkedList<PExp> _exp_ = new LinkedList<PExp>();

    public AAchamadafuncaoChamadaFuncao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAchamadafuncaoChamadaFuncao(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAchamadafuncaoChamadaFuncao(this);
    }
