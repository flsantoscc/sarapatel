...
public final class ASeSenaoExp extends PExp
{
    private TSe _se_;
    ...
    public ASeSenaoExp(
        ...
        @SuppressWarnings("hiding") PIf2 _right_)
    {
        // Constructor
        setSe(_se_);
    ...
    {
        ((Analysis) sw).caseASeSenaoExp(this);
    }
    ...
    public PIf2 getRight()
    {
        return this._right_;
    }

    public void setRight(PIf2 node)
    {
