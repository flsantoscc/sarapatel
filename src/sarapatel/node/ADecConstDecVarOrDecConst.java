...
public final class ADecConstDecVarOrDecConst extends PDecVarOrDecConst
{
    private PDecConst _decConst_;

    public ADecConstDecVarOrDecConst()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecConstDecVarOrDecConst(
    ...
    {
        ((Analysis) sw).caseADecConstDecVarOrDecConst(this);
    }
