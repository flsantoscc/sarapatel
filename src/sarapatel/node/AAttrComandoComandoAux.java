...
public final class AAttrComandoComandoAux extends PComandoAux
{
    private PArrAttr _arrAttr_;
    private PExp _exp_;

    public AAttrComandoComandoAux()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAttrComandoComandoAux(
    ...
    {
        ((Analysis) sw).caseAAttrComandoComandoAux(this);
    }
