...
public final class ADecConstDecVarOrConst extends PDecVarOrConst
{
    private PDecCons _decCons_;

    public ADecConstDecVarOrConst()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecConstDecVarOrConst(
    ...
    {
        ((Analysis) sw).caseADecConstDecVarOrConst(this);
    }
