...
public final class ADecFuncaoDecProcOrFuncao extends PDecProcOrFuncao
{
    private PDecFuncao _decFuncao_;

    public ADecFuncaoDecProcOrFuncao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecFuncaoDecProcOrFuncao(
    ...
    {
        ((Analysis) sw).caseADecFuncaoDecProcOrFuncao(this);
    }
