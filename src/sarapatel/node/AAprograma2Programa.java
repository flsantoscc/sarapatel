...
public final class AAprograma2Programa extends PPrograma
{
    ...
    public Object clone()
    {
        return new AAprograma2Programa(
    ...
    {
        ((Analysis) sw).caseAAprograma2Programa(this);
    }
