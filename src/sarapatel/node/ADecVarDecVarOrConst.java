...
public final class ADecVarDecVarOrConst extends PDecVarOrConst
{
    private PDecVar _decVar_;

    public ADecVarDecVarOrConst()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecVarDecVarOrConst(
    ...
    {
        ((Analysis) sw).caseADecVarDecVarOrConst(this);
    }
