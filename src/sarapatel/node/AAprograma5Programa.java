...
public final class AAprograma5Programa extends PPrograma
{
    ...
    public Object clone()
    {
        return new AAprograma5Programa(
    ...
    {
        ((Analysis) sw).caseAAprograma5Programa(this);
    }
