...
public final class AAchamadaprocedimentoChamadaProcedimento extends PChamadaProcedimento
{
    private TId _id_;
    private final LinkedList<PExp> _exp_ = new LinkedList<PExp>();

    public AAchamadaprocedimentoChamadaProcedimento()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAchamadaprocedimentoChamadaProcedimento(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAchamadaprocedimentoChamadaProcedimento(this);
    }
