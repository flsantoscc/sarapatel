...
public final class ADecVarOrDecConstComandoAux extends PComandoAux
{
    ...
    public Object clone()
    {
        return new ADecVarOrDecConstComandoAux(
    ...
    {
        ((Analysis) sw).caseADecVarOrDecConstComandoAux(this);
    }
