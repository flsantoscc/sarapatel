...
public final class AAchamadafuncao2ChamadaFuncao extends PChamadaFuncao
{
    private TId _id_;
    private final LinkedList<PExp> _exp_ = new LinkedList<PExp>();

    public AAchamadafuncao2ChamadaFuncao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAchamadafuncao2ChamadaFuncao(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAchamadafuncao2ChamadaFuncao(this);
    }
