...
public final class ADecVarDecVarDecConst extends PDecVarDecConst
{
    private PDecVar _decVar_;

    public ADecVarDecVarDecConst()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecVarDecVarDecConst(
    ...
    {
        ((Analysis) sw).caseADecVarDecVarDecConst(this);
    }
