...
public final class APipeParametroPipeParametro extends PPipeParametro
{
    private TPipe _pipe_;
    private PParametro _parametro_;

    public APipeParametroPipeParametro()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APipeParametroPipeParametro(
    ...
    {
        ((Analysis) sw).caseAPipeParametroPipeParametro(this);
    }
